...
public class ColourSelect extends GridPane {
    ...
    private static final double width = 330.0;
    private static final double height = 330.0;
    private static final double border = width * 0.02;
    ...
    public void setRGBColour(Color colour) {
        Debug.trace(DD, "setRGBColour(" + colour.toString() + ")");
        red = colour.getRed();
        gre = colour.getGreen();
        blu = colour.getBlue();
